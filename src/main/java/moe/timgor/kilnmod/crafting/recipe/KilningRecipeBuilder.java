...
public class KilningRecipeBuilder {
    ...
    private KilningRecipeBuilder(IItemProvider p_i50788_1_, Ingredient p_i50788_2_, float p_i50788_3_, int p_i50788_4_, IRecipeSerializer p_i50788_5_) {
    ...
    public static KilningRecipeBuilder kilning(Ingredient p_218631_0_, IItemProvider p_218631_1_, float p_218631_2_, int p_218631_3_) {
        return new KilningRecipeBuilder(p_218631_1_, p_218631_0_, p_218631_2_, p_218631_3_, ModRecipes.Serializers.KILNING_RECIPE.get());
    }

    public KilningRecipeBuilder unlockedBy(String p_218628_1_, ICriterionInstance p_218628_2_) {
