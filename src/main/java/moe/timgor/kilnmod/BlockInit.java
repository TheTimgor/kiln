...
public class BlockInit {
    ...
    public static final RegistryObject<Block> kiln_block = Blocks.register("kiln_block", () -> new Block(AbstractBlock.Properties.of(Material.STONE, MaterialColor.STONE)));
