...
public class BlockInit {
    ...
    public static final RegistryObject<Item> kiln_item = Items.register("kiln", () -> new BlockItem(kiln_block.get(), new Item.Properties().tab(ItemGroup.TAB_BUILDING_BLOCKS)));
